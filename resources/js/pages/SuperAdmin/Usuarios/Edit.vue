...
function submit() {
    form.put(route('superadmin.usuarios.update', props.usuario.id));
}
</script>
...
<template>
    ...
    <div class="min-h-screen bg-white p-10">
        <div class="border-b border-gray-200 pb-6">
            ...
            <h1 class="mt-1 text-2xl font-semibold text-gray-900">Editar usuario</h1>
        </div>
        ...
        <form @submit.prevent="submit" class="mt-8 max-w-md border-l-4 border-[#1b4b43] pl-8">
            ...
            <div class="mt-6">
                <label class="block text-sm text-gray-600">Contraseña nueva (dejar vacío para no cambiarla)</label>
                <input
                    type="password"
